...
const AVIS = [
  ...
  { text: "Un endroit hors du temps. La piscine chauffée, le jardin... tout est parfait. Idéal pour se ressourcer loin du bruit de la ville.", author: 'Sophie', city: 'Bordeaux', date: 'Août 2024', stars: 5 },
