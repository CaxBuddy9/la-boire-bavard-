...
const ROOMS = {
  jardin: {
    ...
    theme: {
      pageBg: '#120c08',
      topbarBg: '#1c1008',
      topbarBorder: 'rgba(200,120,72,.18)',
      accent: '#c87848',
      accentRgb: '200,120,72',
      cardBg: 'rgba(255,248,240,.04)',
      cardBorder: 'rgba(200,120,72,.14)',
      cardShadow: 'none',
      heading: '#fdfcf9',
      text: 'rgba(253,248,242,.88)',
      textSub: 'rgba(253,248,242,.58)',
      textMuted: 'rgba(253,248,242,.38)',
      divider: 'rgba(255,240,220,.08)',
      wifiBg: '#1c1008',
      byeBg: '#1c1008',
      pillBg: 'rgba(200,120,72,.13)',
      pillActiveBg: '#c87848',
      pillActiveText: '#120c08',
      navBg: 'rgba(18,12,8,.96)',
      navBorder: 'rgba(200,120,72,.15)',
      navActive: '#c87848',
      navInactive: 'rgba(253,248,242,.35)',
    } satisfies RoomTheme,
    details: [
