...
const ROOMS = {
  jardin: {
    ...
    theme: {
      pageBg: '#0a1a0c',
      topbarBg: '#0e2012',
      topbarBorder: 'rgba(196,160,80,.18)',
      accent: '#c4a050',
      accentRgb: '196,160,80',
      cardBg: 'rgba(255,255,255,.04)',
      cardBorder: 'rgba(196,160,80,.14)',
      cardShadow: 'none',
      heading: '#fdfcf9',
      ...
      wifiBg: '#0e2012',
      byeBg: '#0e2012',
      pillBg: 'rgba(196,160,80,.13)',
      pillActiveBg: '#c4a050',
      pillActiveText: '#0a1a0c',
      navBg: 'rgba(10,26,12,.96)',
      navBorder: 'rgba(196,160,80,.15)',
      navActive: '#c4a050',
