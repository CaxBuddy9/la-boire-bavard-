    ...
    <main style={{
      ...
      <style>{`
        ...
        .door-panel {
          ...
          animation: doorOpen 1.8s cubic-bezier(.4,0,.2,1) 0.3s both;
        }
        .plaque-swing {
          transform-origin: top center;
          animation: swing 3.2s ease-in-out 2s infinite;
        }
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          >
            ...
            <g className="door-panel">
              ...
              <g className="plaque-swing">
                ...
                <rect x="158" y="270" width="64" height="86" rx="8"
                      fill="#faf7f2" stroke="#c4a050" strokeWidth="1.5"/>
                {/* Monogramme BB — centré dans la plaque, scale 0.375 */}
                ...
                <text x="190" y="333" textAnchor="middle" fontSize="6.5"
                      fontFamily="Arial, sans-serif" fill="#1a3320" letterSpacing="0.8">
                  SCANNEZ-MOI
                </text>
                <text x="190" y="349" textAnchor="middle" fontSize="5.5"
                      fontFamily="Arial, sans-serif" fill="#c4a050" letterSpacing="1">
                  LA BOIRE BAVARD
                </text>
              </g>
            </g>
            ...
            {/* Chambranle doré */}
            <rect x="10" y="0" width="240" height="360" rx="6"
                  fill="none" stroke="#c4a050" strokeWidth="1.5" opacity="0.4"/>
          </svg>
        </div>
            ...
            return (
              <div key={id} style={{
                ...
                <div style={{ padding: '1.25rem', textAlign: 'center' }}>
                  ...
                  />
                  <p style={{
                    fontSize: '0.65rem', color: '#8a8a8a', marginTop: '0.75rem',
        ...
        {/* Instructions */}
        <div style={{
          marginTop: '2rem', padding: '1.25rem', background: '#1a3320',
