...
export default function MeteoWidget() {
  ...
  useEffect(() => {
    fetch('https://api.open-meteo.com/v1/forecast?latitude=47.3952&longitude=-0.3690&current=temperature_2m,weathercode&timezone=Europe%2FParis&forecast_days=1')
      .then((r) => r.json())
      .then((d) => {
        setData({
