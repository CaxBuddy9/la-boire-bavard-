...
export function LogoLLA() {
  return (
    <svg viewBox="0 0 120 60" xmlns="http://www.w3.org/2000/svg" style={{ height: 36, width: 'auto' }}>
...
export function LogoDestinationAnjou() {
  return (
    <svg viewBox="0 0 130 60" xmlns="http://www.w3.org/2000/svg" style={{ height: 36, width: 'auto' }}>
      {/* Losange mosaïque */}
...
export function LogoQualiteTourisme() {
  return (
    <svg viewBox="0 0 100 60" xmlns="http://www.w3.org/2000/svg" style={{ height: 36, width: 'auto' }}>
      {/* Ovale bleu */}
...
export function LogoVignobles() {
  return (
    <svg viewBox="0 0 110 60" xmlns="http://www.w3.org/2000/svg" style={{ height: 36, width: 'auto' }}>
      {/* Cercle vert */}
